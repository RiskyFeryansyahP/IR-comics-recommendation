...
func (e GenreEdges) ComicsOrErr() ([]*Comic, error) {
	if e.loadedTypes[0] {
		return e.Comics, nil
	}
...
// QueryComics queries the "comics" edge of the Genre entity.
func (ge *Genre) QueryComics() *ComicQuery {
	return (&GenreClient{config: ge.config}).QueryComics(ge)
}
